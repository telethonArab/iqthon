...
reasonlistreport = [InputReportReasonChildAbuse(), InputReportReasonFake(), InputReportReasonSpam(), InputReportReasonCopyright(), InputReportReasonGeoIrrelevant(), InputReportReasonOther(), InputReportReasonPornography(), InputReportReasonViolence()]
...
للايقاف :( .ايقاف استثمار وعد )
———————⁂———————
اضافة امر راتب تلقائي : 
( .راتب وعد + عدد الاعادة للأمر )
لايقاف الامر : ( .ايقاف راتب وعد )
———————⁂———————
اضافة امر سرقة وعد :
( .سرقة وعد + الايدي ) 
لايقاف الامر  :( .ايقاف سرقة وعد )
———————⁂———————
اضافة امر بخشيش تلقائي  : 
( .بخشيش وعد + عدد مرات الاعادة )
لايقاف الامر :( .ايقاف بخشيش وعد )
———————⁂———————
